    ...
    <div>
      <div>
        {route.pathname === "/" ? (
          ...
          <div className="lg:flex lg:flex-row lg:justify-between sm:flex sm:flex-col sm:justify-center sm:items-center mt-36 mb-8 py-5 px-[100px]">
            {/* Search Bar */}
            <div>
              <input
                type="text"
            ...
            <div className="lg:flex lg:gap-5 sm:flex sm:gap-0 gap-5">
